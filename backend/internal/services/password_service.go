...
import (
	...
	"github.com/hay-kot/hookfeed/backend/internal/core/mailer"
	...
	"github.com/hay-kot/hookfeed/backend/internal/services/emailtemplates"
	"github.com/hay-kot/hookfeed/backend/pkgs/hasher"
...
func (s *PasswordService) Reset(ctx context.Context, data dtos.PasswordReset) error {
	return s.db.WithinTx(ctx, func(qe *db.QueriesExt) error {
